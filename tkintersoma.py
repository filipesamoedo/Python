...
def somar_numeros():
    ...
    resultado = num1 + num2
    messagebox.showinfo("Resultado",f"A soma dos números e: {resultado}")
...
entry_num2 = tk.Label(janela, text="Número 2:")
entry_num2.grid(row=1, column=0, padx=10, pady=5, sticky="e")
